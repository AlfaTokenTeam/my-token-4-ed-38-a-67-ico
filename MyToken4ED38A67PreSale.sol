...
import "./MyToken4ED38A67.sol";

contract MyToken4ED38A67PreSale {
    MyToken4ED38A67 public token;
    ...
    function MyToken4ED38A67PreSale(
        MyToken4ED38A67 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken4ED38A67(_token);
